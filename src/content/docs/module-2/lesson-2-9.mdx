...
### Learning objectives
- Explain a **Bloom filter** — probabilistic set membership with **no false negatives** and a **tunable false-positive rate** — size one with the rule of thumb (~9.6 bits/element ≈ 1% FP), and connect it to LSM reads (Lesson 2.3) and cache/CDN guards (Lesson 2.10).
