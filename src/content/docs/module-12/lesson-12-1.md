...
- **Identity and auth.** Every request is scoped to a tenant, resolved from the subdomain, JWT claim, or API key, and *every* downstream call is bound to it.
