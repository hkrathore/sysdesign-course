---
title: "12.2 — The Four Answer Frameworks"
...
- **The hypothetical got an efficiency-era twist.** "Scale 15 → 50" used to mean "draw the org chart." Now the first clarify is *whether you hire at all*, headcount is the expensive option, and a candidate who reaches straight for bodies reads as a ZIRP relic.
