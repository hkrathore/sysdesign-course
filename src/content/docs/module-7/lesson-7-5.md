...
- **Historical nodes** load sealed, immutable segments from **deep storage** (S3/HDFS (Hadoop Distributed File System)) and serve queries over the aged data, the bulk of the dataset, from local SSD/memory.
