...
> This lesson is the **building-block concept layer** — the reusable mechanics of serving one model on a GPU fleet. The **full end-to-end RESHADED design** (estimation, the serving system, autoscaling, the cost floor, the trade-off table) is **Lesson 5.15 — ChatGPT / LLM Serving**. This is the Module 3 → Module 5 split: learn the primitive here, watch it drive a complete design there. Don't re-derive 5.15 in your head while reading this — get the mechanics first.
