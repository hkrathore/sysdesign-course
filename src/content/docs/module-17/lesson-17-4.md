---
title: "17.4 - Leadership Philosophy & Style"
...
- Talk culture as **designed, measured mechanisms** (written principles, postmortems, decision logs, attrition and survey trends), never perks or proximity, and hold a **stewardship** stance on RTO (recovery time objective) with the trade-off math.
...
- **Mechanism**, the named, standing practice that makes the position real and verifiable: skip-level cadence, one or two inspected areas per quarter, written operating principles, blameless postmortems with owned actions, a decision log. This is the layer that separates an operator from an inspirational poster (the recipe book and the mise-en-place checks).
...
```mermaid
flowchart TD
    Q["Philosophy question"] --> P["Position<br/>contextual not fixed identity"]
    P --> M["Mechanism<br/>skip levels inspected areas postmortems"]
    M --> N["Number<br/>attrition engagement delivery"]
    N --> L["Limit<br/>real downside and when I change"]
    L --> STOP["Stop and let them probe"]
    STOP --> D1["Founder mode probe"]
    STOP --> D2["What did you inspect last month"]
    STOP --> D3["How would your team describe you"]
```
...
- **"What did you personally inspect at the work level last month?"**, *Strong:* a specific area, why it (risk concentration), and what he found, plus what he deliberately left alone. *Red flag:* nothing concrete, or a generic "I review dashboards", the abdication tell (a chef who never tastes).
...
*End of Lesson 17.4. Philosophy is the calibrated-general round; the next lesson narrows to the hiring bar, designing the loop, the AI-era assessment redesign, and the junior-pipeline stance, where the same "designed mechanism, with a number" instinct from this lesson becomes a system you own.*
