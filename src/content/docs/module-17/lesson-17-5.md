---
title: "17.5 - Hiring Philosophy & the Talent Bar"
...
*End of Lesson 17.5. Hiring is the instrument that fills the org; the next lesson turns to the harder edge of the same bar, the people calls once someone is already inside: low performers, PIPs (performance improvement plans), the brilliant jerk, and the termination you have to run with dignity and decisiveness.*
