...
- **Every loop now scores efficiency-era operation through its own lens.** In 2015 you sold scale everywhere, "I grew the org 10 to 60." Now Meta scores it as **lean talent density**, Amazon as **frugality + ownership**, a startup as **doing it with fewer bodies**. The same growth story without an output-per-dollar angle reads as ZIRP (zero interest-rate policy) empire-building at all five, the *fact* of scaling is fine; leading with headcount growth as the achievement is the dated move.
