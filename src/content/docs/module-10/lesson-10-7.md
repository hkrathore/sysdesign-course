...
*End of Lesson 10.7. Org design is the people-side twin of the Conway's-Law architecture round, same load-path thinking, applied to managers instead of services. The next lesson turns to how you actually *run* the org you've built: the operating system, cadence, the visibility layer that catches a slipping migration at week 3, and the engineering-metrics literacy (DORA, DX Core 4) a 2026 panel now assumes.*
