...
*End of Lesson 15.3. An SLO turns reliability into a negotiated number and the error budget is the currency you spend on velocity, page on by burn rate, and freeze against by written policy, not by argument.*
