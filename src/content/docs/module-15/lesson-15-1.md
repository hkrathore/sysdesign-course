...
- Reason in **MTTR (mean time to recovery) decomposed** (time-to-detect + time-to-diagnose + time-to-mitigate) and weigh the central trade, **mitigate-first vs root-cause-first**, knowing the cost of a wrong fix that prolongs the outage.
