---
title: "15.5 - Blameless Postmortems"
...
> A postmortem is not a document, it is the **delta**: the guardrail, alert, or runbook fix that did not exist this morning. The whole practice turns on one claim about causation: a competent engineer's mistake is a **symptom of system design**, and blame buys you silence plus the same outage under a new name. So you enumerate **contributing factors** (several latent faults aligned, never one root cause) and ship systemic action items with owners and due dates, judged on **close rate and repeat-incident rate**.
...
*End of Lesson 15.5. The postmortem only earns its cost when the truth is safe to tell and the action items actually close, and both of those are the Director's culture to build, not the document's job to carry.*
